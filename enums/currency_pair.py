class CURRENCY_PAIR:
    ...
    BTC_TO_IOTA = 20        # not exist on bittrex
    BTC_TO_BTG = 21
    BTC_TO_WTC = 22         # not exist on bittrex
    BTC_TO_KNC = 23         # not exist on bittrex
    BTC_TO_BAT = 24
    BTC_TO_ZRX = 25         # not exist on bittrex
    BTC_TO_RDN = 26         # not exist on bittrex
    BTC_TO_GAS = 27         # not exist on bittrex
    BTC_TO_ADA = 28
    BTC_TO_RCN = 29
    BTC_TO_QSB = 30         # Not exist on binance, bittrex
    BTC_TO_XBY = 31         # Not exist on binance, bittrex
    BTC_TO_PAC = 32         # Not exist on binance, bittrex
    BTC_TO_RDD = 33         # Not exist on binance
    BTC_TO_ICX = 34         # Not exist on bittrex
    BTC_TO_WABI = 35        # Not exist on bittrex
    BTC_TO_XLM = 36
    BTC_TO_TRX = 37         # Not exist on bittrex
    BTC_TO_AION = 38        # Not exist on bittrex
    BTC_TO_ITC = 39         # Not exist on binance, bittrex
    ...
    ETH_TO_IOTA = 1018      # not exist on bittrex
    ETH_TO_BTG = 1019
    ETH_TO_WTC = 1020       # not exist on bittrex
    ETH_TO_KNC = 1021       # not exist on bittrex
    ETH_TO_BAT = 1022
    ETH_TO_ZRX = 1023       # not exist on bittrex
    ETH_TO_RDN = 1024       # not exist on bittrex
    ETH_TO_GAS = 1025       # Not exist on binance, bittrex
    ETH_TO_ADA = 1026
    ETH_TO_RCN = 1027
    ETH_TO_QSB = 1028       # Not exist on binance, bittrex
    ETH_TO_XBY = 1029       # Not exist on binance, bittrex
    ETH_TO_PAC = 1030       # Not exist on binance, bittrex
    ETH_TO_RDD = 1031       # Not exist on binance, bittrex
    ETH_TO_ICX = 1032       # Not exist on bittrex
    ETH_TO_WABI = 1033      # Not exist on bittrex
    ETH_TO_XLM = 1034
    ETH_TO_TRX = 1035       # Not exist on bittrex
    ETH_TO_AION = 1036      # Not exist on bittrex
