...
def split_currency_pairs(pair_id):
    return {
        ...
        CURRENCY_PAIR.ETH_TO_QSB: (CURRENCY.ETH, CURRENCY.QSB),
        ...
        CURRENCY_PAIR.USDT_TO_QSB: (CURRENCY.USDT, CURRENCY.QSB),
...
def get_pair_id_by_name(pair_name):
    return {
        ...
        "ETH_TO_QSB": CURRENCY_PAIR.ETH_TO_QSB,
        ...
        "USDT_TO_QSB": CURRENCY_PAIR.USDT_TO_QSB,
...
def get_pair_name_by_id(pair_id):
    return {
        ...
        CURRENCY_PAIR.ETH_TO_QSB: "ETH_TO_QSB",
        ...
        CURRENCY_PAIR.USDT_TO_QSB: "USDT_TO_QSB",
