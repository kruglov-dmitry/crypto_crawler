...
ORDER_SAVING_COMMAND = PYTHON_INTERPETATOR + " -m services.order_storing --cfg " + COMMON_CFG
...
BOT_TRADE_SAVING_COMMAND = PYTHON_INTERPETATOR + " -m services.bot_trade_retrieval --cfg " + COMMON_CFG
