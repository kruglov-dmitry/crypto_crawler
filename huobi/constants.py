...
HUOBI_BUY_ORDER = HUOBI_API_URL + "/v1/order/orders/place"

HUOBI_SELL_ORDER = HUOBI_API_URL + "/v1/order/orders/place"

HUOBI_CANCEL_ORDER = HUOBI_API_URL + "/v1/order/orders/"

HUOBI_CHECK_BALANCE = HUOBI_API_URL + "/v1/account/accounts/{account-id}/balance"

HUOBI_GET_OPEN_ORDERS = HUOBI_API_URL + "/v1/order/orders"

HUOBI_GET_TRADE_HISTORY = HUOBI_API_URL + "/market/trade?symbol="

HUOBI_NUM_OF_DEAL_RETRY = 1
HUOBI_DEAL_TIMEOUT = 5

HUOBI_GET_ACCOUNT_INFO = HUOBI_API_URL + "/v1/account/accounts?"
